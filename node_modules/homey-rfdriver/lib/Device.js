...
module.exports = superclass =>
	...
	class RFDevice extends superclass {
		...
		send(data, options = {}) {
			...
			console.log('assembleSendData', data);
			...
			if (!payload) {
				...
				this.setUnavailable(this.translateError(Homey.__('invalid_device_data')));
				return Promise.reject(err);
			}
			...
			console.log('id from data and device', dataCheck.id, this.getData().id);
